// ----------------------------------------
# Define versions of cloud providers to use
// ----------------------------------------
#region
terraform {
  required_providers {
...
// ---------------------------------------------------------------------------------------
# Firewalls for every GCP VPC, allowing GCP traffic and Azure traffic to reach GCP servers
// ---------------------------------------------------------------------------------------
#region
...
// -----------------------------------------------------------------------------------------------------------
# GCP VPC, GCP Region, Azure Region, Azure App for each region, with gateway peering between the cloud regions
// -----------------------------------------------------------------------------------------------------------
#region
...
// ----------------------------------------------------------------------------------
# Enumerate 8 Azure VMs in each region, but different VM types as per available quota
// ----------------------------------------------------------------------------------
#region
...
// ----------------------------------------------------------------------------------
# Enumerate Azure Hub Spoke Peerings from each Region VNets to every App Region VNets
// ----------------------------------------------------------------------------------
#region
...
// ---------------------------------------------------
# Enumerate GCP VPC Peerings between all pairs of VPCs
// ---------------------------------------------------
#region
