...
output "name_fw" {
    description = "Name of the FW in this region."
    value = azurerm_firewall.fw.name
}

output "fw_ip" {
    description = "Private IP address of the FW in this region."
    value = azurerm_firewall.fw.ip_configuration[0].private_ip_address
}


output "name_fw_rt" {
    description = "Name of the FW route table in this region."
    value = azurerm_route_table.route_table_fw.name
}

output "name_vm_rt" {
    description = "Name of the VM route table in this region."
